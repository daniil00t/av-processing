...
with open('../lab5/russian_font_features.csv', 'r', encoding='utf-8') as f:
...
phrase_100 = generate_sentence(120)
euclid_distances_100 = get_probability_list(phrase_100)
...
with open('result_100.txt', 'w', encoding='utf-8') as f:
